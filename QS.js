...
ctx.fillStyle = 'white'; // Set the  initial fill color to white
ctx.fillRect(0, 0, canvas.width, canvas.height); // Fill the entire canvas with thar color


// this will help to choose the text color 
...
// thi will help to choose the bg color
...
retrieveButton.addEventListener("click", () => {
  // Retrieve the  only saved canvas contents from local storage
